...
export default function IncomeUpdate({ response, id, user }) {
    let initialData = {
        UserCreator: user,
        inTitle: response?.income?.inTitle,
        inAmount: response?.income?.inAmount,
        inDescription: response?.income?.inDescription
    }
